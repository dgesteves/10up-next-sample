...
describe('DiscordLogoIcon', () => {
  it('renders with default props', () => {
    render(<DiscordLogoIcon />);
  ...
  it('renders with custom size and color', () => {
    ...
    render(<DiscordLogoIcon size={customSize} color={customColor} />);
    const svgElement = screen.getByRole('presentation', { hidden: true });
    expect(svgElement).toBeInTheDocument();
  ...
  it('renders with title', () => {
    const title = 'Discord Logo Icon';
    render(<DiscordLogoIcon title={title} />);
